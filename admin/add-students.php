...
$sql="insert into tblstudent(StudentName,StudentEmail,StudentClass,Gender,DOB,StuID,FatherName,MotherName,ContactNumber,AltenateNumber,Address,Attendance,CGPA,SGPA,Result,UserName,Password,Image)values(:stuname,:stuemail,:stuclass,:gender,:dob,:stuid,:fname,:mname,:connum,:altconnum,:address,:attendance,:cgpa,:sgpa,:result,:uname,:password,:image)";
...
<html lang="en">
  <head>
    ...
    <title>ANITS Student Portal/Add Students</title>
    <!-- plugins:css -->
...
<option value="<?php echo htmlentities($row1->ID);?>"><?php echo htmlentities($row1->ClassName);?> <?php echo htmlentities($row1->Section);?></option>
 <?php } ?> 
			    ...
			    <div class="form-group">
                        ...
                        <input type="text" name="attendance" value="" class="form-control" required='true'>
                      </div>
			   <div class="form-group">
			    ...
			    <div class="form-group">
                        ...
                        <input type="text" name="sgpa" value="" class="form-control" required='true'>
                      </div>
			     <div class="form-group">
                        <label for="exampleInputName1">Result</label>
                        <input type="text" name="result" value="" class="form-control" required='true'>
                      </div>
